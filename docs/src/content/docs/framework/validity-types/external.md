...
E1–E3 test the breadth of the finding across methods, inputs, and tasks. E4 Cross-model generalization tests whether the mechanism is a property of the computational problem rather than of a single trained instance. E5 Graded response tests the quantitative structure of the causal relationship. E6 Novel prediction tests whether the mechanism has predictive content beyond the observations it was built to explain.
