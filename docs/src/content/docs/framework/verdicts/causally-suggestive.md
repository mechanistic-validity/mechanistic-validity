...
> **Met:** I1 Necessity (mean ablation of circuit heads reduces logit diff by 0.73), M2 Baseline separation (0.73 against 0.12 for a size-matched random set), V1 (claim stated at head level)
