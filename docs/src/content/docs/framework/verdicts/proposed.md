...
This is a Proposed claim. The evidence is correlational and structural: the feature *looks like* it represents noun-hood. But no intervention has been performed. We do not know whether the feature is *causally relevant* to noun-related computation (I1 Necessity), whether it is *sufficient* (I2 Sufficiency), or whether it is *specific* to noun-hood rather than a correlated property like word frequency (I4 Specificity).
