...
Activation patching and causal scrubbing both implement Pearl's do-calculus — they differ in which nodes of the causal graph they intervene on and how they evaluate the circuit hypothesis against the result. The SCM framework is not a metric itself; it is the formal language that makes activation patching and causal scrubbing *mean* something rather than being ad hoc measurement procedures.
