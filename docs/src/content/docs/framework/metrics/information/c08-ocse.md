...
OCSE implements a practical version of [C07 (Granger Causality)](/framework/metrics/information/c07-granger-causality/) with flexibility for nonlinear dependencies. Its directed scores should correlate with [C03 (Transfer Entropy)](/framework/metrics/information/c03-transfer-entropy/) but are cheaper to compute. Discrepancies between OCSE rankings and interventional results from the [causal pillar](/framework/metrics/causal/) reveal redundancy or backup circuits. [C09 (NOTEARS)](/framework/metrics/information/c09-notears/) can use OCSE scores as edge priors for DAG structure learning.
