...
Logit diff recovery is more targeted than full-distribution faithfulness (D01): a circuit might match the model's top-1 prediction without matching the full tail, or vice versa. This metric captures the task-relevant signal specifically.
