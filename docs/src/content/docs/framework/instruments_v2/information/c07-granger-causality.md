...
Granger causality is the linear-model counterpart of [C03 (Transfer Entropy)](/framework/instruments_v2/information/c03-transfer-entropy/) — they are equivalent for Gaussian processes but TE captures nonlinear dependencies. [C08 (OCSE)](/framework/instruments_v2/information/c08-ocse/) implements a flexible version of predictive causality. When GC identifies a link, [C09 (NOTEARS)](/framework/instruments_v2/information/c09-notears/) can incorporate it as a constraint in DAG recovery, and the [causal pillar](/framework/instruments_v2/causal/) validates whether the link is functionally necessary via intervention.
