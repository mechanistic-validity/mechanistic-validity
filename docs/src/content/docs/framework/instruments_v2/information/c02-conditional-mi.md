...
CMI directly feeds into [C04 (PID)](/framework/instruments_v2/information/c04-pid/) which formalizes the redundancy/synergy decomposition. Low CMI combined with high causal effect under [C08 (OCSE)](/framework/instruments_v2/information/c08-ocse/) would be paradoxical — it would mean a component is redundant informationally but not functionally, suggesting backup circuits. See also the [causal pillar](/framework/instruments_v2/causal/) for testing whether CMI tracks with intervention effects.
