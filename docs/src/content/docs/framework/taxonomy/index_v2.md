...
Every circuit claim is a chain from a concrete measurement to a conclusion. This framework names every link in that chain.

Reading bottom-up (layer 1 → 6) is how you build a claim. Reading top-down (6 → 1) is how you audit one. Reading sideways across layer 2 is how you check whether independent methods agree.
...
Most circuit discovery papers should land at *Causally suggestive* or *Mechanistically supported*. That is not a failure. It's an honest description of what activation patching and ablation actually establish.
