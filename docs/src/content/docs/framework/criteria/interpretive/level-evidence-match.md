...
| `[representational]` | M2 (baseline separation); M4 (calibration); M1 (reliability) |
| `[causal-mechanistic]` | I1 (necessity); I2 (sufficiency); I4 (specificity); M2 (baseline separation) |
| `[structural-mechanistic]` | C2 (structural plausibility); I1 (necessity); M2 (baseline separation) |
| `[transportable]` | E2 (prompt generalization) minimum; E4 (cross-model generalization) for strongest form |
