...
| Pass condition | The metric gives comparable results across model sizes and model families — the same construct is being measured |
...
| Common failure mode | Treating cross-scale agreement as assumed; never testing whether the metric measures the same thing in different models |

## What this criterion requires

Invariance asks: when the same metric is applied to a different model size or family, is it measuring the same construct?
