...
# D — How to Choose a Metric: Criterion → Metric Lookup

---

## Internal validity metrics

| Criterion | Primary metric(s) | Evidence family | Notes |
|---|---|---|---|
...
| Criterion | Primary metric(s) | Evidence family | Notes |
|---|---|---|---|
| C1 Falsifiability | Pre-registered threshold statement | N/A | Not a metric — a claim structure requirement; must precede data collection |
...
| C5 Convergent validity | Jaccard(weight-circuit, EAP-circuit) | Measurement | ≥2 metrics, different evidence families; Jaccard ≥ 0.5 = strong convergence |
...
| Phase | Minimum metrics | Additional if time |
|---|---|---|
