...
The mode tag (from the [Description Modes](/v2/description-modes/)) identifies the level at which the claim is stated. The strongest/weakest pairing identifies where the claim is most and least secure. The primary gap names a specific next experiment. The scope bounds the claim.
