...
- [IOI](/framework/lenses_v6/examples/examples-ioi) -- the IOI circuit can be analyzed with this lens via WC_M5 (TDA persistence) and WC_M8 (Koopman DMD) protocols
