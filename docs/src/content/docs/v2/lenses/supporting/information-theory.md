...
The primary contribution of this lens is to [construct validity](/v2/validity-types/construct) (C9) and [internal validity](/v2/validity-types/internal) (I11, I12), with a secondary contribution to [measurement validity](/v2/validity-types/measurement) (M8). Together, these criteria ask whether the circuit has the information-theoretic properties that would make the claimed computation coherent: compression (C9), directed flow (I11), self-sustaining propagation (I12), and efficient use of model capacity (M8).
