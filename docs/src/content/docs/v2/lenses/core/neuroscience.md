...
For formal definitions, quantitative thresholds, and calibration data, see [Internal Validity — Formal Specification](/v2/validity-types/internal).
...
Internal validity is the workhorse of the [verdict system](/v2/verdicts/):
...
- [IOI Circuit](/framework/lenses_v6/examples/examples-ioi) — strong I1/I2, weak I3/I5; method-conditional results
- [Induction Heads](/framework/lenses_v6/examples/examples-induction-heads) — reaches Mechanistically supported; path-level sufficiency
- [SAE Features](/framework/lenses_v6/examples/examples-sae-features) — necessity/sufficiency sometimes; bulk untested
- [Copy Suppression](/framework/lenses_v6/examples/examples-copy-suppression) — unusually clean specificity (I3)
- [Grokking](/framework/lenses_v6/examples/examples-grokking) — all five criteria pass (toy model)
- [Knowledge Neurons](/framework/lenses_v6/examples/examples-knowledge-neurons) — strong I1/I2, weak I3/I5
- [Probing Classifiers](/framework/lenses_v6/examples/examples-probing) — measurement without intervention; I1–I3 all untested
