...
[External validity](/v2/validity-types/external) is the pharmacological question: not whether the effect is real (that is [internal validity](/v2/validity-types/internal)), but how much effect, at what strength, on what target, with what margin. A circuit that satisfies every internal-validity criterion at a single intervention strength can still fail here. The effect may not scale. It may disappear in a different model. Its absolute magnitude may be too small to support the computational story.
