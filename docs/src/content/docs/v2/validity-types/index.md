...
- *Construct validity* is grounded in the [Philosophy of Science](/v2/lenses/core/philosophy-of-science) lens, which provides falsifiability, structural plausibility, task specificity, minimality, and convergent validity criteria.
- *Measurement validity* is grounded in the [Measurement Theory](/v2/lenses/core/measurement-theory) lens, which provides reliability, invariance, baseline separation, sensitivity, calibration, and construct coverage criteria.
- *Internal validity* is grounded in the [Neuroscience](/v2/lenses/core/neuroscience) lens, which provides necessity, sufficiency, specificity, consistency, and confound-control criteria.
- *External validity* is grounded in the [Pharmacology](/v2/lenses/core/pharmacology) lens, which provides intervention reach, graded response, selectivity, effect magnitude, robustness, and cross-architecture generalization criteria.
- *Interpretive validity* is grounded in the [Mechanistic Interpretability](/v2/lenses/core/mechanistic-interpretability) lens, which provides level declaration, level-evidence match, narrative coherence, alternative exclusion, and scope honesty criteria.
