...
| Lens | [Neuroscience](/v2/lenses/core/neuroscience) |
| Criteria | I1–I5 |
| Dependency | Internal validity is the workhorse — most MI evidence is internal-validity evidence. But it says nothing about whether the finding generalizes ([external](/v2/validity-types/external)), whether the metric is reliable ([measurement](/v2/validity-types/measurement)), whether the construct is coherent ([construct](/v2/validity-types/construct)), or whether the narrative is correct ([interpretive](/v2/validity-types/interpretive)). |
| Status in MI | Best-addressed by existing methods; still routinely method-conditional |

Internal validity asks whether the causal inference from intervention to behavior is licensed within the experimental setup. The [Neuroscience lens](/v2/lenses/core/neuroscience) explains the intellectual background. This page gives the formal definitions, quantitative thresholds, and calibration data.
