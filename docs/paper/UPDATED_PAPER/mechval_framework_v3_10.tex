...
\centering
\small
\caption{Seven description modes, ordered from most committal (computational) to least committal (topographic). Higher modes require all evidence from lower modes plus bridging evidence.}
\label{tab:modes}
