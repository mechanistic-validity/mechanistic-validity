...
# Case studies: (name, verdict, construct, internal, measurement, external, interpretive)
case_studies = [
...
def make_radar_grid(case_studies, cols=4, filename='fig_radar_by_tier_v4.png'):
    N = 5
