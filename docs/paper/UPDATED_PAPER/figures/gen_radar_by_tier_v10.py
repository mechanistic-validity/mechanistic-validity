...
def make_vertical_grouped_radars(case_studies, filename, show_dim_labels=True, title_pad_base=12):
    ...
    for tier_idx, (tier_name, items) in enumerate(tier_groups):
        ...
        for j, (name, verdict, c, i, m, e, v) in enumerate(items):
            ...
            # nudge title pad per tier-row — extra space so score doesn't crowd the graph
            title_pad = title_pad_base + 8 + tier_idx * 2
...
if __name__ == '__main__':
    ...
    make_vertical_grouped_radars(cs, 'fig_radar_selective_v2.png', show_dim_labels=True, title_pad_base=12)
