...
def make_vertical_grouped_radars(case_studies, filename, show_dim_labels=True, title_pad_base=12):
    ...
    for tier_idx, (tier_name, items) in enumerate(tier_groups):
        ...
        for j, (name, verdict, c, i, m, e, v) in enumerate(items):
            ...
            title_pad = title_pad_base + tier_idx * 2
    ...
    # adjust margins for compact layout but keep top margin to avoid clipping
...
if __name__ == '__main__':
    ...
    make_no_labels_with_example_legend(cs, 'fig_radar_no_labels_v9.png')
    make_vertical_grouped_radars(cs, 'fig_radar_vertical_v9.png', show_dim_labels=True, title_pad_base=12)
