...
def make_vertical_grouped_radars(case_studies, filename, show_dim_labels=True, title_pad_base=12):
    ...
    tier_ranges = {
        ...
        "Mech. Supported": "Mechanistically Supported",
        "Caus. Suggestive": "Causally Suggestive",
        "Proposed": "Proposed",
    }
...
if __name__ == '__main__':
    ...
    make_vertical_grouped_radars(cs, 'fig_radar_selective_v4.png', show_dim_labels=True, title_pad_base=12)
