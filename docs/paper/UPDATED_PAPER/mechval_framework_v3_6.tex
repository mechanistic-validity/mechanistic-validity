...
\centering
\small
\caption{Seven description modes. Each mode represents a different level of evidential commitment; higher modes require all evidence from lower modes plus bridging evidence.}
\label{tab:modes}
