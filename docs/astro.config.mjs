    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { label: 'Overview', link: '/framework/audits/' },
            { label: 'Induction Heads', link: '/framework/audits/induction' },
            { label: 'Copy Suppression', link: '/framework/audits/copy_suppression' },
            { label: 'Greater-Than', link: '/framework/audits/greater_than' },
            { label: 'Modular Addition', link: '/framework/audits/grokking' },
            { label: 'Refusal Direction', link: '/framework/audits/refusal' },
            { label: 'Successor Heads', link: '/framework/audits/successor_heads' },
            { label: 'Superposition', link: '/framework/audits/superposition' },
            { label: 'Global Workspace', link: '/framework/audits/workspace' },
            { label: 'Docstring Circuit', link: '/framework/audits/docstring' },
            { label: 'Gender Bias Circuits', link: '/framework/audits/gender' },
            { label: 'IOI Circuit', link: '/framework/audits/ioi' },
            { label: 'Othello World Model', link: '/framework/audits/othello' },
            { label: 'SAE Features', link: '/framework/audits/sae' },
            { label: 'Probing Classifiers', link: '/framework/audits/probing' },
            { label: 'Induction Heads (General ICL)', link: '/framework/audits/induction_broad' },
            { label: 'Knowledge Neurons', link: '/framework/audits/knowledge_neurons' },
            { label: 'Sensitivity Analysis', link: '/framework/audits/sensitivity' },
          ],
        },
        {
          label: 'Exploratory Lens Analysis',
          collapsed: true,
          items: [
