...
_MOD_PATH = (
    ...
    / "src" / "mechval" / "metrics" / "extended" / "genetics" / "GN3_chimera.py"
)
...
def results(gpt2_model):
    return run_chimera(gpt2_model, [TASK], n_prompts=5)
...
def test_metric_id(results):
    assert results[0].metric_id == "GN3.chimera"
