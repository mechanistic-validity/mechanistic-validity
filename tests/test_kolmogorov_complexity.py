...
_MOD_PATH = (
    ...
    / "src" / "mechval" / "metrics" / "extended" / "information_theory" / "IT3_kolmogorov_complexity.py"
)
...
run_kolmogorov_complexity = _mod.run_kolmogorov_complexity
...
def results(gpt2_model):
    return run_kolmogorov_complexity(gpt2_model, [TASK], n_prompts=5)
...
def test_metric_id(results):
    assert results[0].metric_id == "IT3.kolmogorov_complexity"
...
def test_n_samples_is_zero(results):
