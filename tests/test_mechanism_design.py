...
_MOD_PATH = (
    ...
    / "src" / "mechval" / "metrics" / "extended" / "economics" / "ECON1_mechanism_design.py"
)
...
run_mechanism_design = _mod.run_mechanism_design
...
def results(gpt2_model):
    return run_mechanism_design(gpt2_model, [TASK], n_prompts=5)
...
def test_metric_id(results):
    assert results[0].metric_id == "ECON1.mechanism_design"
