...
_MOD_PATH = (
    ...
    / "src" / "mechval" / "metrics" / "extended" / "information_theory" / "IT1_channel_capacity.py"
)
...
run_channel_capacity = _mod.run_channel_capacity
...
def results(gpt2_model):
    return run_channel_capacity(gpt2_model, [TASK], n_prompts=5)
...
def test_metric_id(results):
    assert results[0].metric_id == "IT1.channel_capacity"
