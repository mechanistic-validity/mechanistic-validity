...
This module re-exports them as TASK_REGISTRY for _common.py.
"""
from __future__ import annotations

from typing import Any

from lib.tasks import TaskBuilder, TaskPrompt, TokenizerLike

from lib.tasks.ioi.prompts import (
    centering_theory_prompts,
    ioi_prompts,
    resumptive_prompts,
    self_allo_prompts,
)
from lib.tasks.greater_than.prompts import greater_than_prompts
from lib.tasks.copy_suppression.prompts import copy_suppression_prompts
from lib.tasks.induction.prompts import (
    alternating_pair_prompts,
    induction_prompts,
    novel_song_prompts,
    sequence_internal_prompts,
)
from lib.tasks.gendered_pronoun.prompts import gendered_pronoun_prompts
from lib.tasks.sva.prompts import sva_prompts
from lib.tasks.acronym.prompts import acronym_prompts
from lib.tasks.rti.prompts import (
    buffalo_prompts,
    rti_pattern_prompts,
    token_flood_prompts,
)
